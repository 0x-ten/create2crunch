...
To run and get an address that starts and ends with 360, build it and then run:

```sh
$ ./target/release/create2crunch 0x0000000000ffe8b47b3e2130213b802212439497 0000000000000000000000000000000000000000 <initcode-hash> 255 3 5 360 360
```
...
This code is a fork of the original create2crunch to allow prefix and suffixes when running in cpu mode.
